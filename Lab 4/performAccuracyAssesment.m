function [differences, accuracies] = performAccuracyAssesment(objectCoordsPC, controlPoints, realCheckPoints, calcCheckPoints, baseVector, c)
    %UNTITLED Summary of this function goes here
    %   Detailed explanation goes here
    differences = realCheckPoints(:, 2:4) - calcCheckPoints;
